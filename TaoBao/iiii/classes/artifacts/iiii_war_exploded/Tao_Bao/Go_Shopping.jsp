...
$(function() {
	...
	$('.button0').click(function(){
		...
		//console.log(coun1);
		$(location).prop("href", "http://localhost:8080/iiii/Tao_Bao/Update_Go_Shopping.jsp?data="+coun1);
	});
	...
	if($('img').length==0){
		...
		$('.hidebtn').click(function(){
			$(location).prop("href", "http://localhost:8080/iiii/Tao_Bao/Zhu_Ye_Mian.jsp?uaer="+$('.hidebtn').attr('value'));
		});
	}else{
		$('.hidediv').hide();
		$('.hidebtn').hide();
